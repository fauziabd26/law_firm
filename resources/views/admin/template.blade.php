...
<head>
    ...
    <title>{{Session::get('username')}}|Admin</title>
    ...
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <h4 class="name">ADMIN Law Firma Amirrudin & Partners</h4>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            ...
                            <li><a class="waves-effect waves-dark" href="/logoutadmin">Logout</a></li>
                        </li>
                    </ul>
                        </div>
                    </div>
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                               <span><p>Copyright &copy; Law Firma Amirrudin & Partners</p></span> 
                            </div>
                        </div>
                    </div>
                </div>
