            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-dark">Konsultasi
                            <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                            <li><a class="waves-effect waves-dark" href="user-konsultasi">Konsultasi</a></li>
                            <li><a class="waves-effect waves-dark" href="user-jawaban_konsul">Jawaban Konsultasi</a></li>
                        </li>
                        </ul>

                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle waves-effect waves-dark">{{Session::get('username')}}
                            <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                            <li><a class="waves-effect waves-dark" href="{{('/logoutUser')}}">Logout</a></li>
                        </li>
                    </ul>
                </div>
            </div>
